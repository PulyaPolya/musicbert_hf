...
from musicbert_hf.checkpoints_before import (
...
from musicbert_hf.metrics_before import compute_metrics, compute_metrics_multitask
from musicbert_hf.models_before import freeze_layers, MusicBertTokenClassification, MusicBertMultiTaskTokenClassification
...
if __name__ == "__main__":
    cfg =load_config("scripts/save_params_before.yaml")
